...
if auth.is_logged_in():
    response.menu.append((T('Clientes'), False, URL('cliente', 'index'), []))
    response.menu.append((T('Produtos'), False, URL('produto', 'index'), []))
    response.menu.append((T('Serviços'), False, URL('servico', 'index'), []))
    response.menu.append((T('OS'), False, URL('ordem_servico', 'index'), []))
    response.menu.append((T('Nova OS'), False, URL('ordem_servico', 'nova_os'), []))
